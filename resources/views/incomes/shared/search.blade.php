<form method="get" action="{{ route('incomes.index') }}" class="d-flex col-4 mb-3" role="search">
...
<form method="get" action="{{ route('incomes.index') }}" class="d-flex col-4 mb-3" role="filter">
